...
This visualization was nice because it helped ground my picture of the circuit to something visual instead of just an abstract collection of gates. However, in the end this visualizer didn't help out much with reversing the logic in the circuit. It was just too difficult to manipulate and too confusing to read.
